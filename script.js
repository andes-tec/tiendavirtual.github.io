...
let productos = [], carrito = [], currentCategory = "all", aderezosDisponibles = ["Mayonesa", "Mostaza", "Ketcup", "Barbacoa"], isSubmitting = false, currentLang = "es";
...
const TRANSLATIONS = {
  es: {
    tagline: "Los Mejor para tu Negocio", btnUltimoPedido: "📋 Ultimo pedido", btnMisPedidos: "📜 Mis pedidos", productosLabel: "productos", verCarrito: "Ver carrito", cargandoProductos: "Cargando productos...",
    footerTagline: "Los mejor para tu Negocio.", footerHorario: "Horarios", footerLunesVier: "Lun - Vie: 11:00 - 22:00", footerSabDom: "Sab - Dom: 12:00 - 23:00", footerEnvioMin: "🛵 Envio minimo: $500",
    footerSeguinos: "Seguinos", footerSeguro: "Pedidos 100% seguros · Recibilos en tu domicilio", tuCarrito: "Tu carrito", total: "Total", finalizarPedido: "Finalizar pedido",
    datosPedido: "Datos del pedido", secDatosCliente: "Datos del cliente", labelNombre: "Nombre completo *", placeholderNombre: "Ej: Ana Gonzalez", labelTelefono: "Telefono *", placeholderTelefono: "11 2345 6789",
    secTipoPedido: "Como lo recibis?", aDomicilio: "A domicilio", enLocal: "Consumo en local", labelDireccion: "Direccion de envio *", placeholderDireccion: "Calle, numero, ciudad", labelMesa: "Numero de mesa *",
    placeholderMesa: "Ej: Mesa 5", secAderezos: "Aderezos adicionales", opcional: "opcional", secMetodoPago: "Metodo de pago", efectivo: "Efectivo (contra entrega)", transferencia: "Transferencia bancaria",
    aliasParaTransferir: "Alias para transferir:", copiar: "Copiar", secNotas: "Notas / Instrucciones", placeholderNotas: "Ej: sin cebolla, timbre, etc.", confirmarPedido: "Confirmar pedido y enviar",
    ...
    redirigendoWhatsapp: "En unos segundos te llevaremos a WhatsApp para confirmar...", todosBtn: "🛍️ Todos", carritoVacio: "🛒 El carrito esta vacio.", productoAgregado: "agregado", productoEliminado: "Producto eliminado",
    ...
    nombreReq: "Por favor ingresa tu nombre", telefonoReq: "Ingresa un telefono valido", direccionReq: "La direccion de envio es requerida", mesaReq: "Indica el numero de mesa", carritoVacioSend: "El carrito esta vacio",
  ...
  en: {
    tagline: "The Best for your Business", btnUltimoPedido: "📋 Last order", btnMisPedidos: "📜 My orders", productosLabel: "items", verCarrito: "View cart", cargandoProductos: "Loading products...",
    footerTagline: "The Best for your Business.", footerHorario: "Hours", footerLunesVier: "Mon - Fri: 11:00 - 22:00", footerSabDom: "Sat - Sun: 12:00 - 23:00", footerEnvioMin: "🛵 Min. delivery: $500",
    footerSeguinos: "Follow us", footerSeguro: "100% secure orders · Get them at your door", tuCarrito: "Your cart", total: "Total", finalizarPedido: "Checkout",
    datosPedido: "Order details", secDatosCliente: "Customer info", labelNombre: "Full name *", placeholderNombre: "Ex: John Smith", labelTelefono: "Phone *", placeholderTelefono: "555 123 4567",
    secTipoPedido: "How do you want it?", aDomicilio: "Home delivery", enLocal: "Dine in", labelDireccion: "Delivery address *", placeholderDireccion: "Street, number, city", labelMesa: "Table number *",
    placeholderMesa: "Ex: Table 5", secAderezos: "Extra sauces", opcional: "optional", secMetodoPago: "Payment method", efectivo: "Cash on delivery", transferencia: "Bank transfer",
    aliasParaTransferir: "Transfer alias:", copiar: "Copy", secNotas: "Notes / Instructions", placeholderNotas: "Ex: no onion, ring the bell, etc.", confirmarPedido: "Confirm & send order",
    ...
    nombreReq: "Please enter your name", telefonoReq: "Enter a valid phone number", direccionReq: "Delivery address is required", mesaReq: "Please indicate the table number", carritoVacioSend: "Your cart is empty",
  ...
  try {
    ...
    for (let i = 1; i < rows.length; i++) {
      ...
      productos.push({
        ...
        precio: parseFloat(obj.precio) || 0, categoria: obj.categoria || "General", imagen: obj.imagen_url || "https://placehold.co/400x400?text=Producto"
      });
    }
